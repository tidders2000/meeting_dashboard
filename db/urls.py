...
urlpatterns = [
    ...
    path('buildings/<int:pk>', actions_ud, name='actud'),
    path('clinical/<int:pk>', actions_ud, name='actud'),
    path('finance/issue/<int:pk>', issues_ud, name='issud'),
    path('hr/issue/<int:pk>', issues_ud, name='issud'),
    path('clinical/issue/<int:pk>', issues_ud, name='issud'),
    path('buildings/issue/<int:pk>', issues_ud, name='issud'),
